...
var intro_warp=document.getElementById('intro-warp');
...
$('.shift-camera-button').click(function () {
	...
	introTimeline.add([TweenLite.to(xMark, 1, { opacity: 1, ease: Power3.easeInOut }), TweenLite.to(skyContainer, 1, { opacity: 1, ease: Power3.easeInOut })]);
...
function zx() {
	...
	introTimeline.add([TweenLite.fromTo(introContainer, 0,{ opacity: 1 }, { opacity: 0, ease: Power3.easeIn }), TweenLite.to(camera.rotation, 0, { x: Math.PI / 2, ease: Power3.easeInOut }), TweenLite.to(camera.position, 0, { z: 20, ease:Power3.easeInOut}),  TweenLite.to(camera.position, 0, { y: 120, ease: Power3.easeInOut }), TweenLite.to(plane.scale, 0, { x: 2, ease: Power3.easeInOut })]);
	introTimeline.add([TweenLite.to(xMark, 1, { opacity: 1, ease: Power3.easeInOut }), TweenLite.to(skyContainer, 1, { opacity: 1, ease: Power3.easeInOut })]);
	sessionStorage.setItem('index','2');
};
